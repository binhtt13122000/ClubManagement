...
<head>
    ...
    <link href="${pageContext.request.contextPath}/snackbar/snackbar.css" rel="stylesheet" type="text/css">
    <style>
        .card-horizontal {
            display: flex;
            flex: 1 1 auto;
                                    ...
                                    <div class="card-horizontal">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div>
                                                ...
                                                <button ${!event.eventStatus.equals("REGISTER") || event.numRegister == event.total ? "disabled":""} onclick="window.location.href='MainController?btnAction=AddToEventCart&id=${event.eventID}&searchEventTxt=${param.searchEventTxt}'" class="btn btn-danger">Register</button>
                                            </div>
                                        </div>
                                    </div>
