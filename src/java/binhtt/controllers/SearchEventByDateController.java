 ...
 * @author binht
 */
public class SearchEventByDateController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            events = blo.getInRangeDate(start, end);
            request.setAttribute("LIST_EVENT", events);
            request.setAttribute("DISPLAY", true);
        } catch (Exception e){
            log("Exception at SearchEventByDateController: " + e.getMessage());
        } finally {
