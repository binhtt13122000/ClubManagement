...
public class RemoveFromGroupController extends HttpServlet {
    ...
    private static final String SUCCESS = "ViewGroupDetailController";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = blo.deleteUserFromGroup(idMember, id);
            if(check){
                url = SUCCESS;
            }
        } catch (Exception e){
            log("Exception at RemoveFromGroupController: " + e.getMessage());
        } finally {
